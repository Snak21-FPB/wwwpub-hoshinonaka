...
class TestBureauModel(TestCase):
    ...
    def setUpTestData(cls):
        bureaus = [
            Bureau(name=f"テスト局{i}", keyword=f"test_bureau_{i}", sort_num=10 - i)
            for i in range(10)
        ]
    ...
    def test_created_at(self):
        self.assertEqual(
            self.bureau.created_at,
            datetime(2023, 2, 1, 21, 21, 21, tzinfo=dt.timezone.utc),
        )
    ...
    def test_updated_at(self):
        ...
        self.assertEqual(
            ...
            datetime(2023, 2, 1, 22, 22, 22, tzinfo=dt.timezone.utc),
        )
